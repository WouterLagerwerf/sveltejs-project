...
<Reviews on:closeReviews="{() => {show_reviews = false}}" visible={show_reviews} />
<div transition:fade={{duration:200}} class="bg-white">
    <div class="pt-6">
      <nav aria-label="Breadcrumb">
        <ol role="list" class="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <li class="text-sm">
            <a href="/" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600"> {identifier} </a>
          </li>
        </ol>
      </nav>
      ...
      <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
        <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
          <h1 class="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">{identifier}</h1>
        </div>
        ...
        <div class="mt-4 lg:mt-0 lg:row-span-3">
          ...
          <div class="mt-6">
            ...
            <div class="flex items-center">
              ...
              <a href="#" on:click="{() => {show_reviews = true}}" class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">117 reviews</a>
            </div>
          </div>
